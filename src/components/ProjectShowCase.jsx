          ...
          {PROJECTS.map((project, index ) => (
            <div key={index} className='flex flex-col items-center md:flex-row-reverse md:items-start'>
              <div className='w-full p-8 md:w-1/2'>
                <img src={project.imageUrl} alt="" className='w-full rounded-3xl' />
              </div>
              <div className='w-full md:w-1/2'>
                <h2 className='mb-2 text-lg text-emerald-950'>{project.year}</h2>
                <h3 className='mb-2 text-2xl font-semibold text-emerald-950'>{project.title}</h3>
                ...
                <table className='min-w-full text-lg lg:text-xl'>
                  <tbody>
                    <tr>
                      ...
                      <td className='px-6 py-4 text-emerald-950'>{project.figures.investment}</td>
                    </tr>
                    <tr>
                      <td className='px-6 py-4 font-medium text-emerald-950'>Duration</td>
                      <td className='px-6 py-4 font-medium text-emerald-950'>{project.figures.duration}</td>
                    </tr>
                    <tr>
                      <td className='px-6 py-4 font-medium text-emerald-950'>Outcomes</td>
                      <td className='px-6 py-4 font-medium text-emerald-950'>{project.figures.outcome}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
