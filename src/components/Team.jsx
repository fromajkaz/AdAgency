    ...
    <section className='container mx-auto px-8 py-20' id='team'>
      ...
      <div className='flex flex-wrap'>
        {TEAM_MEMBERS.map((member, index) => (
          <div key={index} className='mb-12 flex w-full flex-col items-center px-4 text-center md:w-1/2 lg:w-1/3'>
            <img src={member.image} alt="" className='mb-4 h-48 w-48 rounded-full' />
